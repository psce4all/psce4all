...
#if defined(HALDISPLAYOGL4_EXPORTS)
extern "C" __declspec(dllexport) hal::display::Interface * hal_display$GetInterface(long version);
#else
extern "C"                       hal::display::Interface * hal_display$GetInterface(long version);
#endif
