...
{
    static bool found = false; if (!found) forcef(emu, "needs emit$SRAV"); found = true; __label__; return address + 4;
}
...
{
    static bool found = false; if (!found) forcef(emu, "needs emit$SYNC"); found = true; __label__; return address + 4;
}
...
{
    static bool found = false; if (!found) forcef(emu, "needs emit$MTHI"); found = true; __label__; return address + 4;
}
...
{
    static bool found = false; if (!found) forcef(emu, "needs emit$MTLO"); found = true; __label__; return address + 4;
}
...
{
    static bool found = false; if (!found) forcef(emu, "needs emit$CLO"); found = true; __label__; return address + 4;
}
...
{
    static bool found = false; if (!found) forcef(emu, "needs emit$MADD"); found = true; __label__; return address + 4;
}

/* MADDU */
__noinline u32 Allegrex::ICache::CodeBlock::emit$MADDU(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$MADDU"); found = true; __label__; return address + 4;
}
...
{
    static bool found = false; if (!found) forcef(emu, "needs emit$MSUB"); found = true; __label__; return address + 4;
}

/* MSUBU */
__noinline u32 Allegrex::ICache::CodeBlock::emit$MSUBU(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$MSUBU"); found = true; __label__; return address + 4;
}

/* ROTRV */
__noinline u32 Allegrex::ICache::CodeBlock::emit$ROTRV(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$ROTRV"); found = true; __label__; return address + 4;
}

/* ROTR */
__noinline u32 Allegrex::ICache::CodeBlock::emit$ROTR(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$ROTR"); found = true; __label__; return address + 4;
}
...
__noinline u32 Allegrex::ICache::CodeBlock::emit$BLTZ(u32 address, u32 opcode, bool delayslot)
{
    ...
    __target_label__(DST, address + 8);
    ...
    if (RS)
    {
        ...
        __interpreter_jmp__(address + 8);

        __interpreter_jmp_with_label__(target_address, DST);
...
__noinline u32 Allegrex::ICache::CodeBlock::emit$BLTZL(u32 address, u32 opcode, bool delayslot)
{
    ...
    if (RS)
    {
        ...
        __interpreter_jmp_with_label__(skip_address, address + 8);
...
{
    static bool found = false; if (!found) forcef(emu, "needs emit$BLTZAL"); found = true; __label__; return address + 4;
}

/* BGEZAL */
__noinline u32 Allegrex::ICache::CodeBlock::emit$BGEZAL(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$BGEZAL"); found = true; __label__; return address + 4;
}

/* BLTZALL */
__noinline u32 Allegrex::ICache::CodeBlock::emit$BLTZALL(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$BLTZALL"); found = true; __label__; return address + 4;
}

/* BGEZALL */
__noinline u32 Allegrex::ICache::CodeBlock::emit$BGEZALL(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$BGEZALL"); found = true; __label__; return address + 4;
}
...
{
    static bool found = false; if (!found) forcef(emu, "needs emit$ADDI"); found = true; __label__; return address + 4;
}
...
{
    static bool found = false; if (!found) forcef(emu, "needs emit$MFC0"); found = true; __label__; return address + 4;
}

/* CFC0 */
__noinline u32 Allegrex::ICache::CodeBlock::emit$CFC0(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$CFC0"); found = true; __label__; return address + 4;
}

/* MTC0 */
__noinline u32 Allegrex::ICache::CodeBlock::emit$MTC0(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$MTC0"); found = true; __label__; return address + 4;
}

/* CTC0 */
__noinline u32 Allegrex::ICache::CodeBlock::emit$CTC0(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$CTC0"); found = true; __label__; return address + 4;
}

/* ERET */
__noinline u32 Allegrex::ICache::CodeBlock::emit$ERET(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$ERET"); found = true; __label__; return address + 4;
}

/* MFC1 */
__noinline u32 Allegrex::ICache::CodeBlock::emit$MFC1(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$MFC1"); found = true; __label__; return address + 4;
}

/* CFC1 */
__noinline u32 Allegrex::ICache::CodeBlock::emit$CFC1(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$CFC1"); found = true; __label__; return address + 4;
}
...
{
    static bool found = false; if (!found) forcef(emu, "needs emit$CTC1"); found = true; __label__; return address + 4;
}

/* BC1F */
__noinline u32 Allegrex::ICache::CodeBlock::emit$BC1F(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$BC1F"); found = true; __label__; return address + 4;
}

/* BC1T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$BC1T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$BC1T"); found = true; __label__; return address + 4;
}

/* BC1FL */
__noinline u32 Allegrex::ICache::CodeBlock::emit$BC1FL(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$BC1FL"); found = true; __label__; return address + 4;
}

/* BC1TL */
__noinline u32 Allegrex::ICache::CodeBlock::emit$BC1TL(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$BC1TL"); found = true; __label__; return address + 4;
}
...
{
    static bool found = false; if (!found) forcef(emu, "needs emit$SUB_S"); found = true; __label__; return address + 4;
}
...
{
    static bool found = false; if (!found) forcef(emu, "needs emit$SQRT_S"); found = true; __label__; return address + 4;
}

/* ABS_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$ABS_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$ABS_S"); found = true; __label__; return address + 4;
}
...
{
    static bool found = false; if (!found) forcef(emu, "needs emit$NEG_S"); found = true; __label__; return address + 4;
}

/* ROUND_W_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$ROUND_W_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$ROUND_W_S"); found = true; __label__; return address + 4;
}

/* TRUNC_W_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$TRUNC_W_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$TRUNC_W_S"); found = true; __label__; return address + 4;
}

/* CEIL_W_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$CEIL_W_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$CEIL_W_S"); found = true; __label__; return address + 4;
}

/* FLOOR_W_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$FLOOR_W_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$FLOOR_W_S"); found = true; __label__; return address + 4;
}

/* CVT_W_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$CVT_W_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$CVT_W_S"); found = true; __label__; return address + 4;
}

/* C_F_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$C_F_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$C_COND_S<0>"); found = true; __label__; return address + 4;
}

/* C_UN_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$C_UN_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$C_COND_S<1>"); found = true; __label__; return address + 4;
}

/* C_EQ_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$C_EQ_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$C_COND_S<2>"); found = true; __label__; return address + 4;
}

/* C_UEQ_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$C_UEQ_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$C_COND_S<3>"); found = true; __label__; return address + 4;
}

/* C_OLT_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$C_OLT_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$C_COND_S<4>"); found = true; __label__; return address + 4;
}

/* C_ULT_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$C_ULT_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$C_COND_S<5>"); found = true; __label__; return address + 4;
}

/* C_OLE_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$C_OLE_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$C_COND_S<6>"); found = true; __label__; return address + 4;
}

/* C_ULE_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$C_ULE_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$C_COND_S<7>"); found = true; __label__; return address + 4;
}

/* C_SF_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$C_SF_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$C_COND_S<8>"); found = true; __label__; return address + 4;
}

/* C_NGLE_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$C_NGLE_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$C_COND_S<9>"); found = true; __label__; return address + 4;
}

/* C_SEQ_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$C_SEQ_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$C_COND_S<10>"); found = true; __label__; return address + 4;
}

/* C_NGL_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$C_NGL_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$C_COND_S<11>"); found = true; __label__; return address + 4;
}

/* C_LT_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$C_LT_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$C_COND_S<12>"); found = true; __label__; return address + 4;
}

/* C_NGE_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$C_NGE_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$C_COND_S<13>"); found = true; __label__; return address + 4;
}

/* C_LE_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$C_LE_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$C_COND_S<14>"); found = true; __label__; return address + 4;
}

/* C_NGT_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$C_NGT_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$C_COND_S<15>"); found = true; __label__; return address + 4;
}
...
{
    static bool found = false; if (!found) forcef(emu, "needs emit$MFV"); found = true; __label__; return address + 4;
}

/* MFVC */
__noinline u32 Allegrex::ICache::CodeBlock::emit$MFVC(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$MFVC"); found = true; __label__; return address + 4;
}

/* MTV */
__noinline u32 Allegrex::ICache::CodeBlock::emit$MTV(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$MTV"); found = true; __label__; return address + 4;
}

/* MTVC */
__noinline u32 Allegrex::ICache::CodeBlock::emit$MTVC(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$MTVC"); found = true; __label__; return address + 4;
}

/* BVF */
__noinline u32 Allegrex::ICache::CodeBlock::emit$BVF(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$BVF"); found = true; __label__; return address + 4;
}

/* BVT */
__noinline u32 Allegrex::ICache::CodeBlock::emit$BVT(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$BVT"); found = true; __label__; return address + 4;
}

/* BVFL */
__noinline u32 Allegrex::ICache::CodeBlock::emit$BVFL(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$BVFL"); found = true; __label__; return address + 4;
}

/* BVTL */
__noinline u32 Allegrex::ICache::CodeBlock::emit$BVTL(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$BVTL"); found = true; __label__; return address + 4;
}
...
__noinline u32 Allegrex::ICache::CodeBlock::emit$BEQL(u32 address, u32 opcode, bool delayslot)
{
    ...
    if (RS != RT) __interpreter_jmp_with_label__(skip_address, address + 8);
...
{
    static bool found = false; if (!found) forcef(emu, "needs emit$BLEZL"); found = true; __label__; return address + 4;
}
...
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VADD<1>"); found = true; __label__; return address + 4;
}

/* VADD_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VADD_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VADD<2>"); found = true; __label__; return address + 4;
}

/* VADD_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VADD_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VADD<3>"); found = true; __label__; return address + 4;
}

/* VADD_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VADD_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VADD<4>"); found = true; __label__; return address + 4;
}

/* VSUB_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSUB_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSUB<1>"); found = true; __label__; return address + 4;
}

/* VSUB_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSUB_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSUB<2>"); found = true; __label__; return address + 4;
}

/* VSUB_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSUB_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSUB<3>"); found = true; __label__; return address + 4;
}

/* VSUB_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSUB_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSUB<4>"); found = true; __label__; return address + 4;
}

/* VSBN_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSBN_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSBN<1>"); found = true; __label__; return address + 4;
}

/* VDIV_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VDIV_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VDIV<1>"); found = true; __label__; return address + 4;
}

/* VDIV_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VDIV_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VDIV<2>"); found = true; __label__; return address + 4;
}

/* VDIV_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VDIV_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VDIV<3>"); found = true; __label__; return address + 4;
}

/* VDIV_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VDIV_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VDIV<4>"); found = true; __label__; return address + 4;
}

/* VMUL_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMUL_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMUL<1>"); found = true; __label__; return address + 4;
}

/* VMUL_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMUL_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMUL<2>"); found = true; __label__; return address + 4;
}

/* VMUL_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMUL_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMUL<3>"); found = true; __label__; return address + 4;
}

/* VMUL_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMUL_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMUL<4>"); found = true; __label__; return address + 4;
}

/* VDOT_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VDOT_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VDOT<2>"); found = true; __label__; return address + 4;
}

/* VDOT_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VDOT_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VDOT<3>"); found = true; __label__; return address + 4;
}

/* VDOT_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VDOT_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VDOT<4>"); found = true; __label__; return address + 4;
}

/* VSCL_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSCL_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSCL<2>"); found = true; __label__; return address + 4;
}

/* VSCL_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSCL_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSCL<3>"); found = true; __label__; return address + 4;
}

/* VSCL_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSCL_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSCL<4>"); found = true; __label__; return address + 4;
}

/* VHDP_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VHDP_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VHDP<2>"); found = true; __label__; return address + 4;
}

/* VHDP_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VHDP_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VHDP<3>"); found = true; __label__; return address + 4;
}

/* VHDP_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VHDP_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VHDP<4>"); found = true; __label__; return address + 4;
}

/* VCRS_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VCRS_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VCRS<3>"); found = true; __label__; return address + 4;
}

/* VDET_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VDET_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VDET<2>"); found = true; __label__; return address + 4;
}

/* VCMP_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VCMP_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VCMP<1>"); found = true; __label__; return address + 4;
}

/* VCMP_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VCMP_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VCMP<2>"); found = true; __label__; return address + 4;
}

/* VCMP_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VCMP_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VCMP<3>"); found = true; __label__; return address + 4;
}

/* VCMP_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VCMP_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VCMP<4>"); found = true; __label__; return address + 4;
}

/* VMIN_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMIN_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMIN<1>"); found = true; __label__; return address + 4;
}

/* VMIN_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMIN_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMIN<2>"); found = true; __label__; return address + 4;
}

/* VMIN_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMIN_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMIN<3>"); found = true; __label__; return address + 4;
}

/* VMIN_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMIN_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMIN<4>"); found = true; __label__; return address + 4;
}

/* VMAX_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMAX_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMAX<1>"); found = true; __label__; return address + 4;
}

/* VMAX_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMAX_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMAX<2>"); found = true; __label__; return address + 4;
}

/* VMAX_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMAX_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMAX<3>"); found = true; __label__; return address + 4;
}

/* VMAX_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMAX_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMAX<4>"); found = true; __label__; return address + 4;
}

/* VSCMP_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSCMP_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSCMP<1>"); found = true; __label__; return address + 4;
}

/* VSCMP_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSCMP_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSCMP<2>"); found = true; __label__; return address + 4;
}

/* VSCMP_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSCMP_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSCMP<3>"); found = true; __label__; return address + 4;
}

/* VSCMP_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSCMP_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSCMP<4>"); found = true; __label__; return address + 4;
}

/* VSGE_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSGE_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSGE<1>"); found = true; __label__; return address + 4;
}

/* VSGE_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSGE_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSGE<2>"); found = true; __label__; return address + 4;
}

/* VSGE_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSGE_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSGE<3>"); found = true; __label__; return address + 4;
}

/* VSGE_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSGE_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSGE<4>"); found = true; __label__; return address + 4;
}

/* VSLT_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSLT_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSLT<1>"); found = true; __label__; return address + 4;
}

/* VSLT_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSLT_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSLT<2>"); found = true; __label__; return address + 4;
}

/* VSLT_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSLT_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSLT<3>"); found = true; __label__; return address + 4;
}

/* VSLT_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSLT_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSLT<4>"); found = true; __label__; return address + 4;
}

/* HALT */
__noinline u32 Allegrex::ICache::CodeBlock::emit$HALT(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$HALT"); found = true; __label__; return address + 4;
}

/* MFIC */
__noinline u32 Allegrex::ICache::CodeBlock::emit$MFIC(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$MFIC"); found = true; __label__; return address + 4;
}

/* MTIC */
__noinline u32 Allegrex::ICache::CodeBlock::emit$MTIC(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$MTIC"); found = true; __label__; return address + 4;
}

/* MFDR */
__noinline u32 Allegrex::ICache::CodeBlock::emit$MFDR(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$MFDR"); found = true; __label__; return address + 4;
}

/* DRET */
__noinline u32 Allegrex::ICache::CodeBlock::emit$DRET(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$DRET"); found = true; __label__; return address + 4;
}

/* DBREAK */
__noinline u32 Allegrex::ICache::CodeBlock::emit$DBREAK(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$DBREAK"); found = true; __label__; return address + 4;
}

/* MTDR */
__noinline u32 Allegrex::ICache::CodeBlock::emit$MTDR(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$MTDR"); found = true; __label__; return address + 4;
}
...
{
    static bool found = false; if (!found) forcef(emu, "needs emit$WSBH"); found = true; __label__; return address + 4;
}

/* WSBW */
__noinline u32 Allegrex::ICache::CodeBlock::emit$WSBW(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$WSBW"); found = true; __label__; return address + 4;
}
...
{
    static bool found = false; if (!found) forcef(emu, "needs emit$BITREV"); found = true; __label__; return address + 4;
}
...
{
    static bool found = false; if (!found) forcef(emu, "needs emit$SWL"); found = true; __label__; return address + 4;
}
...
{
    static bool found = false; if (!found) forcef(emu, "needs emit$SWR"); found = true; __label__; return address + 4;
}
...
{
    static bool found = false; if (!found) forcef(emu, "needs emit$ICACHE_INDEX_INVALIDATE"); found = true; __label__; return address + 4;
}

/* ICACHE_INDEX_UNLOCK */
__noinline u32 Allegrex::ICache::CodeBlock::emit$ICACHE_INDEX_UNLOCK(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$ICACHE_INDEX_UNLOCK"); found = true; __label__; return address + 4;
}
...
{
    static bool found = false; if (!found) forcef(emu, "needs emit$ICACHE_HIT_INVALIDATE"); found = true; __label__; return address + 4;
}

/* ICACHE_FILL */
__noinline u32 Allegrex::ICache::CodeBlock::emit$ICACHE_FILL(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$ICACHE_FILL"); found = true; __label__; return address + 4;
}
...
{
    static bool found = false; if (!found) forcef(emu, "needs emit$ICACHE_FILL_WITH_LOCK"); found = true; __label__; return address + 4;
}
...
{
    static bool found = false; if (!found) forcef(emu, "needs emit$DCACHE_INDEX_WRITEBACK_INVALIDATE"); found = true; __label__; return address + 4;
}

/* DCACHE_INDEX_UNLOCK */
__noinline u32 Allegrex::ICache::CodeBlock::emit$DCACHE_INDEX_UNLOCK(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$DCACHE_INDEX_UNLOCK"); found = true; __label__; return address + 4;
}
...
{
    static bool found = false; if (!found) forcef(emu, "needs emit$DCACHE_CREATE_DIRTY_EXCLUSIVE"); found = true; __label__; return address + 4;
}
...
{
    static bool found = false; if (!found) forcef(emu, "needs emit$DCACHE_HIT_INVALIDATE"); found = true; __label__; return address + 4;
}
...
{
    static bool found = false; if (!found) forcef(emu, "needs emit$DCACHE_HIT_WRITEBACK"); found = true; __label__; return address + 4;
}
...
{
    static bool found = false; if (!found) forcef(emu, "needs emit$DCACHE_HIT_WRITEBACK_INVALIDATE"); found = true; __label__; return address + 4;
}
...
{
    static bool found = false; if (!found) forcef(emu, "needs emit$DCACHE_CREATE_DIRTY_EXCLUSIVE_WITH_LOCK"); found = true; __label__; return address + 4;
}

/* DCACHE_FILL */
__noinline u32 Allegrex::ICache::CodeBlock::emit$DCACHE_FILL(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$DCACHE_FILL"); found = true; __label__; return address + 4;
}
...
{
    static bool found = false; if (!found) forcef(emu, "needs emit$DCACHE_FILL_WITH_LOCK"); found = true; __label__; return address + 4;
}

/* LL */
__noinline u32 Allegrex::ICache::CodeBlock::emit$LL(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$LL"); found = true; __label__; return address + 4;
}
...
{
    static bool found = false; if (!found) forcef(emu, "needs emit$LV_S"); found = true; __label__; return address + 4;
}

/* VMOV_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMOV_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMOV<1>"); found = true; __label__; return address + 4;
}

/* VMOV_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMOV_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMOV<2>"); found = true; __label__; return address + 4;
}

/* VMOV_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMOV_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMOV<3>"); found = true; __label__; return address + 4;
}

/* VMOV_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMOV_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMOV<4>"); found = true; __label__; return address + 4;
}

/* VABS_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VABS_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VABS<1>"); found = true; __label__; return address + 4;
}

/* VABS_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VABS_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VABS<2>"); found = true; __label__; return address + 4;
}

/* VABS_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VABS_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VABS<3>"); found = true; __label__; return address + 4;
}

/* VABS_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VABS_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VABS<4>"); found = true; __label__; return address + 4;
}

/* VNEG_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VNEG_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VNEG<1>"); found = true; __label__; return address + 4;
}

/* VNEG_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VNEG_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VNEG<2>"); found = true; __label__; return address + 4;
}

/* VNEG_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VNEG_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VNEG<3>"); found = true; __label__; return address + 4;
}

/* VNEG_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VNEG_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VNEG<4>"); found = true; __label__; return address + 4;
}

/* VIDT_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VIDT_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VIDT<1>"); found = true; __label__; return address + 4;
}

/* VIDT_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VIDT_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VIDT<2>"); found = true; __label__; return address + 4;
}

/* VIDT_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VIDT_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VIDT<3>"); found = true; __label__; return address + 4;
}

/* VIDT_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VIDT_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VIDT<4>"); found = true; __label__; return address + 4;
}

/* VSAT0_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSAT0_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSAT0<1>"); found = true; __label__; return address + 4;
}

/* VSAT0_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSAT0_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSAT0<2>"); found = true; __label__; return address + 4;
}

/* VSAT0_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSAT0_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSAT0<3>"); found = true; __label__; return address + 4;
}

/* VSAT0_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSAT0_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSAT0<4>"); found = true; __label__; return address + 4;
}

/* VSAT1_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSAT1_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSAT1<1>"); found = true; __label__; return address + 4;
}

/* VSAT1_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSAT1_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSAT1<2>"); found = true; __label__; return address + 4;
}

/* VSAT1_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSAT1_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSAT1<3>"); found = true; __label__; return address + 4;
}

/* VSAT1_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSAT1_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSAT1<4>"); found = true; __label__; return address + 4;
}

/* VZERO_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VZERO_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VZERO<1>"); found = true; __label__; return address + 4;
}

/* VZERO_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VZERO_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VZERO<2>"); found = true; __label__; return address + 4;
}

/* VZERO_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VZERO_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VZERO<3>"); found = true; __label__; return address + 4;
}

/* VZERO_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VZERO_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VZERO<4>"); found = true; __label__; return address + 4;
}

/* VONE_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VONE_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VONE<1>"); found = true; __label__; return address + 4;
}

/* VONE_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VONE_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VONE<2>"); found = true; __label__; return address + 4;
}

/* VONE_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VONE_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VONE<3>"); found = true; __label__; return address + 4;
}

/* VONE_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VONE_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VONE<4>"); found = true; __label__; return address + 4;
}

/* VRCP_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VRCP_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VRCP<1>"); found = true; __label__; return address + 4;
}

/* VRCP_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VRCP_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VRCP<2>"); found = true; __label__; return address + 4;
}

/* VRCP_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VRCP_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VRCP<3>"); found = true; __label__; return address + 4;
}

/* VRCP_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VRCP_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VRCP<4>"); found = true; __label__; return address + 4;
}

/* VRSQ_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VRSQ_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VRSQ<1>"); found = true; __label__; return address + 4;
}

/* VRSQ_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VRSQ_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VRSQ<2>"); found = true; __label__; return address + 4;
}

/* VRSQ_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VRSQ_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VRSQ<3>"); found = true; __label__; return address + 4;
}

/* VRSQ_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VRSQ_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VRSQ<4>"); found = true; __label__; return address + 4;
}

/* VSIN_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSIN_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSIN<1>"); found = true; __label__; return address + 4;
}

/* VSIN_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSIN_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSIN<2>"); found = true; __label__; return address + 4;
}

/* VSIN_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSIN_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSIN<3>"); found = true; __label__; return address + 4;
}

/* VSIN_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSIN_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSIN<4>"); found = true; __label__; return address + 4;
}

/* VCOS_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VCOS_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VCOS<1>"); found = true; __label__; return address + 4;
}

/* VCOS_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VCOS_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VCOS<2>"); found = true; __label__; return address + 4;
}

/* VCOS_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VCOS_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VCOS<3>"); found = true; __label__; return address + 4;
}

/* VCOS_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VCOS_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VCOS<4>"); found = true; __label__; return address + 4;
}

/* VEXP2_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VEXP2_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VEXP2<1>"); found = true; __label__; return address + 4;
}

/* VEXP2_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VEXP2_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VEXP2<2>"); found = true; __label__; return address + 4;
}

/* VEXP2_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VEXP2_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VEXP2<3>"); found = true; __label__; return address + 4;
}

/* VEXP2_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VEXP2_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VEXP2<4>"); found = true; __label__; return address + 4;
}

/* VLOG2_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VLOG2_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VLOG2<1>"); found = true; __label__; return address + 4;
}

/* VLOG2_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VLOG2_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VLOG2<2>"); found = true; __label__; return address + 4;
}

/* VLOG2_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VLOG2_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VLOG2<3>"); found = true; __label__; return address + 4;
}

/* VLOG2_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VLOG2_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VLOG2<4>"); found = true; __label__; return address + 4;
}

/* VSQRT_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSQRT_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSQRT<1>"); found = true; __label__; return address + 4;
}

/* VSQRT_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSQRT_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSQRT<2>"); found = true; __label__; return address + 4;
}

/* VSQRT_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSQRT_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSQRT<3>"); found = true; __label__; return address + 4;
}

/* VSQRT_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSQRT_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSQRT<4>"); found = true; __label__; return address + 4;
}

/* VASIN_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VASIN_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VASIN<1>"); found = true; __label__; return address + 4;
}

/* VASIN_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VASIN_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VASIN<2>"); found = true; __label__; return address + 4;
}

/* VASIN_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VASIN_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VASIN<3>"); found = true; __label__; return address + 4;
}

/* VASIN_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VASIN_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VASIN<4>"); found = true; __label__; return address + 4;
}

/* VNRCP_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VNRCP_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VNRCP<1>"); found = true; __label__; return address + 4;
}

/* VNRCP_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VNRCP_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VNRCP<2>"); found = true; __label__; return address + 4;
}

/* VNRCP_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VNRCP_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VNRCP<3>"); found = true; __label__; return address + 4;
}

/* VNRCP_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VNRCP_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VNRCP<4>"); found = true; __label__; return address + 4;
}

/* VNSIN_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VNSIN_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VNSIN<1>"); found = true; __label__; return address + 4;
}

/* VNSIN_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VNSIN_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VNSIN<2>"); found = true; __label__; return address + 4;
}

/* VNSIN_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VNSIN_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VNSIN<3>"); found = true; __label__; return address + 4;
}

/* VNSIN_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VNSIN_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VNSIN<4>"); found = true; __label__; return address + 4;
}

/* VREXP2_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VREXP2_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VREXP2<1>"); found = true; __label__; return address + 4;
}

/* VREXP2_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VREXP2_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VREXP2<2>"); found = true; __label__; return address + 4;
}

/* VREXP2_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VREXP2_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VREXP2<3>"); found = true; __label__; return address + 4;
}

/* VREXP2_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VREXP2_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VREXP2<4>"); found = true; __label__; return address + 4;
}

/* VRNDS_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VRNDS_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VRNDS<1>"); found = true; __label__; return address + 4;
}

/* VRNDI_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VRNDI_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VRNDI<1>"); found = true; __label__; return address + 4;
}

/* VRNDI_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VRNDI_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VRNDI<2>"); found = true; __label__; return address + 4;
}

/* VRNDI_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VRNDI_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VRNDI<3>"); found = true; __label__; return address + 4;
}

/* VRNDI_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VRNDI_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VRNDI<4>"); found = true; __label__; return address + 4;
}

/* VRNDF1_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VRNDF1_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VRNDF1<1>"); found = true; __label__; return address + 4;
}

/* VRNDF1_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VRNDF1_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VRNDF1<2>"); found = true; __label__; return address + 4;
}

/* VRNDF1_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VRNDF1_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VRNDF1<3>"); found = true; __label__; return address + 4;
}

/* VRNDF1_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VRNDF1_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VRNDF1<4>"); found = true; __label__; return address + 4;
}

/* VRNDF2_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VRNDF2_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VRNDF2<1>"); found = true; __label__; return address + 4;
}

/* VRNDF2_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VRNDF2_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VRNDF2<2>"); found = true; __label__; return address + 4;
}

/* VRNDF2_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VRNDF2_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VRNDF2<3>"); found = true; __label__; return address + 4;
}

/* VRNDF2_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VRNDF2_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VRNDF2<4>"); found = true; __label__; return address + 4;
}

/* VF2H_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VF2H_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VF2H<2>"); found = true; __label__; return address + 4;
}

/* VF2H_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VF2H_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VF2H<4>"); found = true; __label__; return address + 4;
}

/* VH2F_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VH2F_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VH2F<1>"); found = true; __label__; return address + 4;
}

/* VH2F_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VH2F_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VH2F<2>"); found = true; __label__; return address + 4;
}

/* VSBZ_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSBZ_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSBZ<1>"); found = true; __label__; return address + 4;
}

/* VLGB_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VLGB_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VLGB<1>"); found = true; __label__; return address + 4;
}

/* VUC2I_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VUC2I_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VUC2I<1>"); found = true; __label__; return address + 4;
}

/* VC2I_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VC2I_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VC2I<1>"); found = true; __label__; return address + 4;
}

/* VUS2I_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VUS2I_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VUS2I<1>"); found = true; __label__; return address + 4;
}

/* VUS2I_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VUS2I_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VUS2I<2>"); found = true; __label__; return address + 4;
}

/* VS2I_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VS2I_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VS2I<1>"); found = true; __label__; return address + 4;
}

/* VS2I_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VS2I_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VS2I<2>"); found = true; __label__; return address + 4;
}

/* VI2UC_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VI2UC_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VI2UC<4>"); found = true; __label__; return address + 4;
}

/* VI2C_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VI2C_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VI2C<4>"); found = true; __label__; return address + 4;
}

/* VI2US_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VI2US_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VI2US<2>"); found = true; __label__; return address + 4;
}

/* VI2US_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VI2US_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VI2US<4>"); found = true; __label__; return address + 4;
}

/* VI2S_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VI2S_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VI2S<2>"); found = true; __label__; return address + 4;
}

/* VI2S_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VI2S_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VI2S<4>"); found = true; __label__; return address + 4;
}

/* VSRT1_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSRT1_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSRT1<4>"); found = true; __label__; return address + 4;
}

/* VSRT2_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSRT2_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSRT2<4>"); found = true; __label__; return address + 4;
}

/* VBFY1_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VBFY1_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VBFY1<2>"); found = true; __label__; return address + 4;
}

/* VBFY1_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VBFY1_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VBFY1<4>"); found = true; __label__; return address + 4;
}

/* VBFY2_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VBFY2_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VBFY2<4>"); found = true; __label__; return address + 4;
}

/* VOCP_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VOCP_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VOCP<1>"); found = true; __label__; return address + 4;
}

/* VOCP_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VOCP_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VOCP<2>"); found = true; __label__; return address + 4;
}

/* VOCP_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VOCP_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VOCP<3>"); found = true; __label__; return address + 4;
}

/* VOCP_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VOCP_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VOCP<4>"); found = true; __label__; return address + 4;
}

/* VSOCP_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSOCP_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSOCP<1>"); found = true; __label__; return address + 4;
}

/* VSOCP_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSOCP_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSOCP<2>"); found = true; __label__; return address + 4;
}

/* VFAD_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VFAD_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VFAD<2>"); found = true; __label__; return address + 4;
}

/* VFAD_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VFAD_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VFAD<3>"); found = true; __label__; return address + 4;
}

/* VFAD_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VFAD_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VFAD<4>"); found = true; __label__; return address + 4;
}

/* VAVG_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VAVG_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VAVG<2>"); found = true; __label__; return address + 4;
}

/* VAVG_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VAVG_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VAVG<3>"); found = true; __label__; return address + 4;
}

/* VAVG_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VAVG_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VAVG<4>"); found = true; __label__; return address + 4;
}

/* VSRT3_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSRT3_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSRT3<4>"); found = true; __label__; return address + 4;
}

/* VSRT4_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSRT4_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSRT4<4>"); found = true; __label__; return address + 4;
}

/* VSGN_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSGN_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSGN<1>"); found = true; __label__; return address + 4;
}

/* VSGN_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSGN_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSGN<2>"); found = true; __label__; return address + 4;
}

/* VSGN_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSGN_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSGN<3>"); found = true; __label__; return address + 4;
}

/* VSGN_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSGN_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSGN<4>"); found = true; __label__; return address + 4;
}

/* VMFVC */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMFVC(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMFVC"); found = true; __label__; return address + 4;
}

/* VMTVC */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMTVC(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMTVC"); found = true; __label__; return address + 4;
}

/* VT4444_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VT4444_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VT4444<4>"); found = true; __label__; return address + 4;
}

/* VT5551_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VT5551_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VT5551<4>"); found = true; __label__; return address + 4;
}

/* VT5650_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VT5650_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VT5650<4>"); found = true; __label__; return address + 4;
}

/* VCST_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VCST_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VCST<1>"); found = true; __label__; return address + 4;
}

/* VCST_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VCST_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VCST<2>"); found = true; __label__; return address + 4;
}

/* VCST_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VCST_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VCST<3>"); found = true; __label__; return address + 4;
}

/* VCST_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VCST_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VCST<4>"); found = true; __label__; return address + 4;
}

/* VF2IN_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VF2IN_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VF2IN<1>"); found = true; __label__; return address + 4;
}

/* VF2IN_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VF2IN_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VF2IN<2>"); found = true; __label__; return address + 4;
}

/* VF2IN_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VF2IN_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VF2IN<3>"); found = true; __label__; return address + 4;
}

/* VF2IN_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VF2IN_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VF2IN<4>"); found = true; __label__; return address + 4;
}

/* VF2IZ_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VF2IZ_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VF2IZ<1>"); found = true; __label__; return address + 4;
}

/* VF2IZ_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VF2IZ_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VF2IZ<2>"); found = true; __label__; return address + 4;
}

/* VF2IZ_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VF2IZ_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VF2IZ<3>"); found = true; __label__; return address + 4;
}

/* VF2IZ_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VF2IZ_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VF2IZ<4>"); found = true; __label__; return address + 4;
}

/* VF2IU_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VF2IU_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VF2IU<1>"); found = true; __label__; return address + 4;
}

/* VF2IU_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VF2IU_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VF2IU<2>"); found = true; __label__; return address + 4;
}

/* VF2IU_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VF2IU_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VF2IU<3>"); found = true; __label__; return address + 4;
}

/* VF2IU_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VF2IU_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VF2IU<4>"); found = true; __label__; return address + 4;
}

/* VF2ID_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VF2ID_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VF2ID<1>"); found = true; __label__; return address + 4;
}

/* VF2ID_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VF2ID_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VF2ID<2>"); found = true; __label__; return address + 4;
}

/* VF2ID_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VF2ID_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VF2ID<3>"); found = true; __label__; return address + 4;
}

/* VF2ID_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VF2ID_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VF2ID<4>"); found = true; __label__; return address + 4;
}

/* VI2F_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VI2F_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VI2F<1>"); found = true; __label__; return address + 4;
}

/* VI2F_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VI2F_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VI2F<2>"); found = true; __label__; return address + 4;
}

/* VI2F_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VI2F_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VI2F<3>"); found = true; __label__; return address + 4;
}

/* VI2F_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VI2F_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VI2F<4>"); found = true; __label__; return address + 4;
}

/* VCMOVT_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VCMOVT_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VCMOVT<1>"); found = true; __label__; return address + 4;
}

/* VCMOVT_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VCMOVT_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VCMOVT<2>"); found = true; __label__; return address + 4;
}

/* VCMOVT_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VCMOVT_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VCMOVT<3>"); found = true; __label__; return address + 4;
}

/* VCMOVT_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VCMOVT_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VCMOVT<4>"); found = true; __label__; return address + 4;
}

/* VCMOVF_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VCMOVF_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VCMOVF<1>"); found = true; __label__; return address + 4;
}

/* VCMOVF_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VCMOVF_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VCMOVF<2>"); found = true; __label__; return address + 4;
}

/* VCMOVF_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VCMOVF_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VCMOVF<3>"); found = true; __label__; return address + 4;
}

/* VCMOVF_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VCMOVF_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VCMOVF<4>"); found = true; __label__; return address + 4;
}

/* VWBN_S */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VWBN_S(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VWBN<1>"); found = true; __label__; return address + 4;
}

/* LVL_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$LVL_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$LVL_Q"); found = true; __label__; return address + 4;
}

/* LVR_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$LVR_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$LVR_Q"); found = true; __label__; return address + 4;
}

/* LV_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$LV_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$LV_Q"); found = true; __label__; return address + 4;
}

/* VPFXS */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VPFXS(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VPFXS"); found = true; __label__; return address + 4;
}

/* VPFXT */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VPFXT(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VPFXT"); found = true; __label__; return address + 4;
}

/* VPFXD */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VPFXD(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VPFXD"); found = true; __label__; return address + 4;
}

/* VIIM */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VIIM(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VIIM"); found = true; __label__; return address + 4;
}

/* VFIM */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VFIM(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VFIM"); found = true; __label__; return address + 4;
}

/* SC */
__noinline u32 Allegrex::ICache::CodeBlock::emit$SC(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$SC"); found = true; __label__; return address + 4;
}
...
{
    static bool found = false; if (!found) forcef(emu, "needs emit$SV_S"); found = true; __label__; return address + 4;
}

/* VMMUL_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMMUL_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMMUL<2>"); found = true; __label__; return address + 4;
}

/* VMMUL_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMMUL_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMMUL<3>"); found = true; __label__; return address + 4;
}

/* VMMUL_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMMUL_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMMUL<4>"); found = true; __label__; return address + 4;
}

/* VHTFM2_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VHTFM2_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VHTFM2<1>"); found = true; __label__; return address + 4;
}

/* VTFM2_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VTFM2_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VTFM2<2>"); found = true; __label__; return address + 4;
}

/* VHTFM3_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VHTFM3_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VHTFM3<2>"); found = true; __label__; return address + 4;
}

/* VTFM3_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VTFM3_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VTFM3<3>"); found = true; __label__; return address + 4;
}

/* VHTFM4_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VHTFM4_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VHTFM4<3>"); found = true; __label__; return address + 4;
}

/* VTFM4_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VTFM4_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VTFM4<4>"); found = true; __label__; return address + 4;
}

/* VMSCL_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMSCL_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMSCL<2>"); found = true; __label__; return address + 4;
}

/* VMSCL_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMSCL_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMSCL<3>"); found = true; __label__; return address + 4;
}

/* VMSCL_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMSCL_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMSCL<4>"); found = true; __label__; return address + 4;
}

/* VCRSP_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VCRSP_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VCRSP<3>"); found = true; __label__; return address + 4;
}

/* VQMUL_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VQMUL_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VQMUL<4>"); found = true; __label__; return address + 4;
}

/* VMMOV_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMMOV_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMMOV<2>"); found = true; __label__; return address + 4;
}

/* VMMOV_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMMOV_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMMOV<3>"); found = true; __label__; return address + 4;
}

/* VMMOV_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMMOV_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMMOV<4>"); found = true; __label__; return address + 4;
}

/* VMIDT_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMIDT_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMIDT<2>"); found = true; __label__; return address + 4;
}

/* VMIDT_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMIDT_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMIDT<3>"); found = true; __label__; return address + 4;
}

/* VMIDT_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMIDT_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMIDT<4>"); found = true; __label__; return address + 4;
}

/* VMZERO_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMZERO_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMZERO<2>"); found = true; __label__; return address + 4;
}

/* VMZERO_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMZERO_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMZERO<3>"); found = true; __label__; return address + 4;
}

/* VMZERO_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMZERO_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMZERO<4>"); found = true; __label__; return address + 4;
}

/* VMONE_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMONE_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMONE<2>"); found = true; __label__; return address + 4;
}

/* VMONE_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMONE_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMONE<3>"); found = true; __label__; return address + 4;
}

/* VMONE_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VMONE_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VMONE<4>"); found = true; __label__; return address + 4;
}

/* VROT_P */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VROT_P(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VROT<2>"); found = true; __label__; return address + 4;
}

/* VROT_T */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VROT_T(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VROT<3>"); found = true; __label__; return address + 4;
}

/* VROT_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VROT_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VROT<4>"); found = true; __label__; return address + 4;
}

/* SVL_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$SVL_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$SVL_Q"); found = true; __label__; return address + 4;
}

/* SVR_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$SVR_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$SVR_Q"); found = true; __label__; return address + 4;
}

/* SV_Q */
__noinline u32 Allegrex::ICache::CodeBlock::emit$SV_Q(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$SV_Q"); found = true; __label__; return address + 4;
}

/* VNOP */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VNOP(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VNOP"); found = true; __label__; return address + 4;
}

/* VSYNC */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VSYNC(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VSYNC"); found = true; __label__; return address + 4;
}

/* VFLUSH */
__noinline u32 Allegrex::ICache::CodeBlock::emit$VFLUSH(u32 address, u32 opcode, bool delayslot)
{
    static bool found = false; if (!found) forcef(emu, "needs emit$VFLUSH"); found = true; __label__; return address + 4;
}
